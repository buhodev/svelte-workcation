...
<header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
  <div class="flex justify-between px-4 py-3 xl:w-72 xl:bg-gray-900 xl:justify-center xl:py-5">
    ...
    <div class="flex sm:hidden">
      <button on:click="{toggle}" type="button" class="px-2 text-gray-500 hover:text-white focus:outline-none focus:text-white">
  ...
  <nav class="{ !isOpen ? 'hidden' : 'block' } sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between">
    ...
    <div class="sm:flex sm:items-center">
      <div class="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:px-0">
        <a href="#list-your-property" class="block px-3 py-1 rounded font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 xl:text-gray-900 xl:hover:bg-gray-200">List your property</a>
        ...
        <a href="#messages" class="mt-1 block px-3 py-1 rounded font-semibold text-white hover:bg-gray-800 sm:mt-0 sm:text-sm sm:px-2 sm:ml-2 xl:text-gray-900 xl:hover:bg-gray-200">Messages</a>
      </div>
      <div class="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
        ...
        <Dropdown class="hidden sm:block" let:hasFocus let:isOpen>
          <span slot="trigger" class="{(hasFocus || isOpen) ? 'border-white xl:border-indigo-500' : 'border-gray-600 xl:border-gray-300'} block h-8 w-8 overflow-hidden rounded-full border-2"
          >
          ...
          <div slot="dropdown" class="mt-3 bg-white xl:border rounded-lg w-48 py-2 shadow-xl">
