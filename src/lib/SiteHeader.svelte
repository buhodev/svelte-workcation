...
<header class="bg-gray-900 sm:flex sm:items-center sm:justify-between xl:bg-white">
	<div class="flex justify-between px-4 py-3 xl:w-72 xl:justify-center xl:bg-gray-900 xl:py-5">
		...
		<div class="flex sm:hidden">
			<button
				on:click={toggle}
				type="button"
				class="px-2 text-gray-500 hover:text-white focus:text-white focus:outline-none"
			>
	...
	<nav
		class="{!isOpen
			? 'hidden'
			: 'block'} sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-between"
	>
		<div class="hidden xl:relative xl:block xl:w-full xl:max-w-xs">
			...
			<input
				class="block w-full rounded-lg border border-transparent bg-gray-200 py-2 pl-10 pr-4 text-gray-900 focus:border-gray-300 focus:bg-white focus:outline-none"
				placeholder="Search by keywords"
			/>
		</div>
		<div class="sm:flex sm:items-center">
			<div class="border-b border-gray-800 px-2 pt-2 pb-5 sm:flex sm:border-b-0 sm:py-0 sm:px-0">
				<a
					href="#list-your-property"
					class="block rounded px-3 py-1 font-semibold text-white hover:bg-gray-800 sm:px-2 sm:text-sm xl:text-gray-900 xl:hover:bg-gray-200"
					>List your property</a
				>
				<a
					href="#trips"
					class="mt-1 block rounded px-3 py-1 font-semibold text-white hover:bg-gray-800 sm:mt-0 sm:ml-2 sm:px-2 sm:text-sm xl:text-gray-900 xl:hover:bg-gray-200"
					>Trips</a
				>
				<a
					href="#messages"
			...
			<div class="relative px-5 py-5 sm:ml-4 sm:py-0 sm:px-0">
				<div class="flex items-center sm:hidden">
					<img
						class="h-10 w-10 rounded-full border-2 border-gray-600 object-cover"
				...
				<Dropdown class="hidden sm:block" let:hasFocus let:isOpen>
					<span
						slot="trigger"
						class="{hasFocus || isOpen
							? 'border-white xl:border-indigo-500'
							: 'border-gray-600 xl:border-gray-300'} block h-8 w-8 overflow-hidden rounded-full border-2"
					>
						<img
					...
					<div slot="dropdown" class="mt-3 w-48 rounded-lg bg-white py-2 shadow-xl xl:border">
						<a
							href="#account"
						...
						<a
							href="#support"
							class="mt-0 block px-4 py-2 text-gray-800 hover:bg-indigo-500 hover:text-white"
							>Support</a
						>
						<a
							href="#sign-out"
